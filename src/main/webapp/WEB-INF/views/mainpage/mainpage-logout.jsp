...
<body>
	...
	<div class="mainpage-header">
		...
		<div class="mainpage-header-menu">
			<p>서비스 소개</p>
			<p>고객지원</p>
			<button class="mainpage-start-btn">
	...
	<div class="mainpage-logout-container">
		...
		<button class="mainpage-start-btn mainpage-start-btn2">
			<span class="mainpage-btn-text">시작하기</span> 
			<span class="mainpage-btn-text"><i class="fa-solid fa-arrow-right"></i></span>
		</button>
	</div>
	...
	<div class="mainpage-footer">
		<div class="mp-footer-left">
			<span> 주식회사 비즈보드 </span><br>
			<span> 대표자 김동욱 </span><br>
			<span> Tel)070-231-6083 </span><br>
			<span> 충청남도 천안시 동남구 대흥동 134 </span>
		</div>
		<div class="mp-footer-right">
			<span> contact@bizboard.com </span><br>
			<span> <a>고객지원 문의하기</a></span><br>
			<span> 사업자등록번호 250-86-01023 </span><br>
			<span> 통신판매업 신고번호 2025-충남천안-10972 </span>
		</div>
	</div>
</body>
</html>