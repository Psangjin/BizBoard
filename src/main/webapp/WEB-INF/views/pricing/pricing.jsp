...
<body>
	...
	<div class="pricing-info">
		<div class="pricing-free pricing-border">
			...
			<div class="pricing-description">개인 사용자 또는 소규모 팀에게 적합</div>
		...
		<div class="pricing-basic pricing-border">
			...
			<div class="pricing-description">협업이 필요한 소규모 팀에게 추천</div>
			<div class="pricing-seperate-line"></div>
			<ul class="pricing-features">
				<li>✔ 공유 문서 보기</li>
				<li>✔ 알림 기능 제공</li>
				<li>✔ 공지 및 푸시 알림</li>
				<li>✔ 기본 테마 + 색상 커스터마이징</li>
			</ul>
		</div>
		...
		<div class="pricing-standard pricing-border">
			...
			<div class="pricing-description">중대형 팀과 고급 기능이 필요한 사용자</div>
			<div class="pricing-seperate-line"></div>
			<ul class="pricing-features">
				<li>✔ 고급 캘린더 설정 + 권한 관리</li>
				<li>✔ 공유 문서 편집</li>
				<li>✔ 실시간 채팅 + 전담 지원</li>
				<li>✔ 다양한 테마 및 커스터마이징</li>
				<li>✔ 고급 통계 + 다운로드 기능</li>
			</ul>
		</div>		
	</div>
